...
def build_sam3_image_model(
    ...
    eval_mode=True,
    checkpoint_path="./sam3/sam3.pt",  # 改动1：默认根目录的sam3.pt
    load_from_HF=False,  # 改动2：默认关闭从HF下载
    ...
    Args:
        ...
        load_from_HF: Whether to load from Hugging Face Hub
...
def build_sam3_video_model(
    checkpoint_path: Optional[str] = "./sam3.pt",  # 改动3：默认根目录的sam3.pt
    load_from_HF=False,  # 改动4：默认关闭从HF下载
